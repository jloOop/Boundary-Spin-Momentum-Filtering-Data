...
# -*- coding: utf-8 -*-
"""
3-D Crank–Nicolson Schrödinger Solver with spectral reflection diagnostics.

Purpose:
  - Keep the CN / TDSE / spinor-ABC implementation unchanged.
  - Do NOT use Bohmian trajectories.
  - Do NOT use interior-plane first-bounce window fitting.
  - Diagnose reflection directly from the wave function by:
      1) roof net backflow,
      2) windowed longitudinal kz decomposition,
      3) tangential Pi+/Pi- decomposition of the spinor ABC boundary matrix,
      4) Duhamel relative-error diagnostic.

Main physical question:
  Is the spinor ABC producing an ordinary propagating reflected wave,
  or only a near-roof evanescent/slab-storage sector?
"""
